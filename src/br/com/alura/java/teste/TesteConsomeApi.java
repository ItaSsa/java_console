...
import br.com.alura.java.module.TopMovieDataDetail;

public class TesteConsomeApi {

	public static void main(String[] args) throws Exception {
		
//		Recupera os top 250 filmes
		TopMovieDataDetail rankMovies = new TopMovieDataDetail();
	
		String body = rankMovies.recuperarRankImdb("https://imdb-api.com/en/API/Top250Movies/k_750a15lt");
			
		
//		Escrevendo no arquivo o json recuperado
		 OutputStream fos = new FileOutputStream("top250movies.json");
